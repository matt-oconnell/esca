	...
	var SDK = function () {
	   ...
	   */
			value: function createExperience(_ref) {
				...
				return _Client2.default.request(_Settings2.default.experienceURL, data);
			}
	   ...
	   */
			...
			value: function payload(appKey) {
				...
				return _Client2.default.request(_Settings2.default.payloadURL, data);
			}
